...
% Last Modified by GUIDE v2.5 06-Jan-2018 02:46:57
...
%---------------------------Do All Again------------------------
    ...
    q1 = GetQuatFrom2Vec(init_vector,GetRotVec(3,?,?));%Aqui esta el follon, el mousex/y ya no estan y no tendria sentido guardalo so ni pajolera idea de como solucionarlo
    set(handles.q1_0,'String',q1(1,1));
    set(handles.q1_1,'String',q1(2,1));
    set(handles.q1_2,'String',q1(3,1));
    set(handles.q1_3,'String',q1(4,1));

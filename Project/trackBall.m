...
q1(1,1) = str2double(get(handles.q1_0,'String'));
q1(2,1) = str2double(get(handles.q1_1,'String'));
q1(3,1) = str2double(get(handles.q1_2,'String'));
q1(4,1) = str2double(get(handles.q1_3,'String'));

e_ang=quat2eul(q1);
r_mat=eAngles2rotM(e_ang(1),e_ang(2),e_ang(3));
%---------------------------Do All Again------------------------
